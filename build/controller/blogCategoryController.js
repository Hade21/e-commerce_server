...
const createCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newCategory = yield blogCategoryModel_1.default.create(req.body);
        return res
            .status(201)
...
const updateCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const updatedCategory = yield blogCategoryModel_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
        });
        if (!updatedCategory)
...
const getAllCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const allCategory = yield blogCategoryModel_1.default.find();
        if (!allCategory)
...
const getSingleCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const category = yield blogCategoryModel_1.default.findById(id);
        if (!category)
            return res.status(404).json({ message: "Category not found" });
...
const deleteCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        yield blogCategoryModel_1.default.findByIdAndDelete(id);
